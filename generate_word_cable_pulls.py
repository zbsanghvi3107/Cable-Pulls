...
class Generate_Word_Cable_Pulls:
    ...
    def generate_final_report(file_name, file_name1, fixed_dir
        ...
        for f in range(no_of_files):
            ...
            document.add_heading('Cable Pull test Summary for '
                                + str(fw_no_names[f])  
                                + '\\' + str(chassis_names[f])
                                +  '\\'  + str(cntrllr_names[f])
                                + ' chassis' ,level=3)
            ...
            #   F2 Menu
            ###################
            document.add_heading('Cable Pull (F2 menu) in '
                                + str(fw_no_names[f])  
                                +'\\' + str(chassis_names[f])
                                +  '\\'  + str(cntrllr_names[f])
                                + ' chassis' ,level=3)
            ...
            document.add_heading('Cable Pull (F3 menu) in '
                                + str(fw_no_names[f]) 
                                + '\\' + str(chassis_names[f])
                                +  '\\'  + str(cntrllr_names[f]) 
                                + ' chassis',level=3)
